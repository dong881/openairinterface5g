                                                      ...
                                                      unsigned int *G)
{
  ...
  int sub = rminfo.O_ack > 2 ? rminfo.Q_dash_ACK : rminfo.E_uci_ACK;
  rminfo.Q_dash_CSI1 = get_Qd(ocsi1, beta_csi1, alpha, sumKr, s1, s1, sub);
  ...
  sub = rminfo.Q_dash_CSI1 + (rminfo.O_ack > 2 ? rminfo.Q_dash_ACK : 0);
